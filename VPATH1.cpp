// Program link: https://tinhoclk.com/problem/vpath1
// Program name: v 
#define TASK  "VPATH1"
// sol: 
...
{     
    ...
    ll C1(ll x,ll y,ll sx,ll sy)
    {
        ...
        return (C(n-1,m+n-2)-(C(x1-1,y1+x1-2)*C(x2-1,x2+y2-2)) %MOD +MOD) %MOD;
    }
    ...
    void sol()
    {
        ...
        // cout<<mau[2]<<el;
        // cout<<C(1,2)<<el;
        if(k==0) cout<<C(n-1,m+n-2);
        else if(k==1) cout<<C1(n,m,a[1].x,a[1].y);
        // {
